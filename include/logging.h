...
namespace logging
{
	...
	public:
        ...
        inline logger& log(level l, const stacktrace::stacktrace_exception& e) { return nlog(l, "ANON", "", e); }
        inline logger& log(level l, const std::string& name, const std::exception& e) { return nlog(l, "ANON",name + e.what()); }
        inline logger& log(level l, const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(l, "ANON", str, e); }
        ...
        inline logger& trace(const stacktrace::stacktrace_exception& e) { return nlog(TRACE, "ANON", e); }
        inline logger& trace(const std::string& str, const std::exception& e) { return nlog(TRACE, "ANON", str, e); }
        inline logger& trace(const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(TRACE, "ANON", str, e); }
        ...
        inline logger& debug(const stacktrace::stacktrace_exception& e) { return nlog(DEBUG, "ANON", e); }
        inline logger& debug(const std::string& str, const std::exception& e) { return nlog(DEBUG, "ANON", str, e); }
        inline logger& debug(const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(DEBUG, "ANON", str, e); }
        ...
        inline logger& info(const stacktrace::stacktrace_exception& e) { return nlog(INFO, "ANON", e); }
        inline logger& info(const std::string& str, const std::exception& e) { return nlog(INFO, str, "ANON", e); }
        inline logger& info(const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(INFO, "ANON", str, e); }
        ...
        inline logger& warn(const stacktrace::stacktrace_exception& e) { return nlog(WARN, "ANON", e); }
        inline logger& warn(const std::string& str, const std::exception& e) { return nlog(WARN, "ANON", str, e); }
        inline logger& warn(const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(WARN, "ANON", str, e); }
        ...
        inline logger& error(const stacktrace::stacktrace_exception& e) { return nlog(ERROR, "ANON", e); }
        inline logger& error(const std::string& str, const std::exception& e) { return nlog(ERROR, "ANON", str, e); }
        inline logger& error(const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(ERROR, "ANON", str, e); }
        ...
        inline void fatal(const stacktrace::stacktrace_exception& e, int o = -1) { nlog(FATAL, "ANON", e); std::exit(o); }
        inline void fatal(const std::string& str, const std::exception& e, int o = -1) { nlog(FATAL, "ANON", str, e); std::exit(o); }
        inline void fatal(const std::string& str, const stacktrace::stacktrace_exception& e, int o = -1) { nlog(FATAL, "ANON", str, e); std::exit(o); }
        ...
        inline logger& nlog(level l, const std::string& name, const stacktrace::stacktrace_exception& e) { return nlog(l, name, "", e); }
        ...
        logger& nlog(level l, const std::string& name, const std::string& str, const stacktrace::stacktrace_exception& e);
        ...
        inline logger& ntrace(const std::string& name, const stacktrace::stacktrace_exception& e) { return log(TRACE, name, e); }
        inline logger& ntrace(const std::string& name, const std::string& str, const std::exception& e) { return nlog(TRACE, name, str, e); }
        inline logger& ntrace(const std::string& name, const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(TRACE, name, str, e); }
        ...
        inline logger& ndebug(const std::string& name, const stacktrace::stacktrace_exception& e) { return nlog(DEBUG, name, e); }
        inline logger& ndebug(const std::string& name, const std::string& str, const std::exception& e) { return nlog(DEBUG, name, str, e); }
        inline logger& ndebug(const std::string& name, const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(DEBUG, name, str, e); }
        ...
        inline logger& ninfo(const std::string& name, const stacktrace::stacktrace_exception& e) { return nlog(INFO, name, e); }
        inline logger& ninfo(const std::string& name, const std::string& str, const std::exception& e) { return nlog(INFO, name, str, e); }
        inline logger& ninfo(const std::string& name, const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(INFO, name, str, e); }
        ...
        inline logger& nwarn(const std::string& name, const stacktrace::stacktrace_exception& e) { return nlog(WARN, name, e); }
        inline logger& nwarn(const std::string& name, const std::string& str, const std::exception& e) { return nlog(WARN, name, str, e); }
        inline logger& nwarn(const std::string& name, const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(WARN, name, str, e); }
        ...
        inline logger& nerror(const std::string& name, const stacktrace::stacktrace_exception& e) { return nlog(ERROR, name, e); }
        inline logger& nerror(const std::string& name, const std::string& str, const std::exception& e) { return nlog(ERROR, name, str, e); }
        inline logger& nerror(const std::string& name, const std::string& str, const stacktrace::stacktrace_exception& e) { return nlog(ERROR, name, str, e); }
        ...
        inline void nfatal(const std::string& name, const stacktrace::stacktrace_exception& e, int o = -1) { nlog(FATAL, name, e); std::exit(o); }
        ...
        inline void nfatal(const std::string& name, const std::string& str, const stacktrace::stacktrace_exception& e, int o = -1) { nlog(FATAL, name, str, e); std::exit(o); }
	};
