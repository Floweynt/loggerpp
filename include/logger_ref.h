...
namespace logging
{
    ...
    public:
        ...
        inline logger& log(logger::level l, const stacktrace::stacktrace_exception& e) { return logger::get_instance().nlog(l, name, e); }
        inline logger& log(logger::level l, const std::string& str, const std::exception& e) { return logger::get_instance().nlog(l, name, str, e); }
        inline logger& log(logger::level l, const std::string& str, const stacktrace::stacktrace_exception& e) { return logger::get_instance().nlog(l, name, str, e); }
        ...
        inline logger& trace(const stacktrace::stacktrace_exception& e) { return log(logger::TRACE, e); }
        inline logger& trace(const std::string& str, const std::exception& e) { return log(logger::TRACE, str, e); }
        inline logger& trace(const std::string& str, const stacktrace::stacktrace_exception& e) { return log(logger::TRACE, str, e); }
        ...
        inline logger& debug(const stacktrace::stacktrace_exception& e) { return log(logger::DEBUG, e); }
        inline logger& debug(const std::string& str, const std::exception& e) { return log(logger::DEBUG, str, e); }
        inline logger& debug(const std::string& str, const stacktrace::stacktrace_exception& e) { return log(logger::DEBUG, str, e); }
        ...
        inline logger& info(const stacktrace::stacktrace_exception& e) { return log(logger::INFO, e); }
        inline logger& info(const std::string& str, const std::exception& e) { return log(logger::INFO, str, e); }
        inline logger& info(const std::string& str, const stacktrace::stacktrace_exception& e) { return log(logger::INFO, str, e); }
        ...
        inline logger& warn(const stacktrace::stacktrace_exception& e) { return log(logger::WARN, e); }
        inline logger& warn(const std::string& str, const std::exception& e) { return log(logger::WARN, str, e); }
        inline logger& warn(const std::string& str, const stacktrace::stacktrace_exception& e) { return log(logger::WARN, str, e); }
        ...
        inline logger& error(const stacktrace::stacktrace_exception& e) { return log(logger::ERROR, e); }
        inline logger& error(const std::string& str, const std::exception& e) { return log(logger::ERROR, str, e); }
        inline logger& error(const std::string& str, const stacktrace::stacktrace_exception& e) { return log(logger::ERROR, str, e); }
        ...
        inline void fatal(const stacktrace::stacktrace_exception& e, int o = -1) { log(logger::FATAL, e); std::exit(o); }
        inline void fatal(const std::string& str, const std::exception& e, int o = -1) { log(logger::FATAL, str, e); std::exit(o); }
        inline void fatal(const std::string& str, const stacktrace::stacktrace_exception& e, int o = -1) { log(logger::FATAL, str, e); std::exit(o); }
    };
}
